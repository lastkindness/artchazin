<?php if($services_slider = get_sub_field('services_slider')): ?>
    ...
    <section <?php if($id = get_sub_field('id')): echo 'id="' . $id . '"'; endif;?> class="top-slider">
        <div class="container">
            <div class="top-slider__wrapper <?php if (count($services_slider)>3) : echo ' swiper'; endif ; ?>">
                <?php if($services_slider_title = get_sub_field('services_slider_title')): ?>
                    <h1 class="top-slider__title"><?php echo $services_slider_title;?></h1>
                <?php endif ; ?>
                <?php if($services_slider_description = get_sub_field('services_slider_description')): ?>
                    <div class="top-slider__descr">
                        <p class="p3"><?php echo $services_slider_description;?></p>
                    </div>
                <?php endif ; ?>
                <?php $white_cards = get_sub_field('services_white_cards'); ?>
                <div class="top-slider__cardwrap <?php if (count($services_slider)>3) : echo ' swiper-wrapper'; endif ; ?>">
                    <?php while (have_rows('services_slider')) : the_row() ?>
                        <?php if($slide = get_sub_field('slide')) : ?>
                            ...
                            ?>
                            <div class="top-slider__card card card_article <?php if ($white_cards) : echo ' card_white'; endif ; ?> <?php if (count($services_slider)>3) : echo ' swiper-slide'; endif ; ?>">
                                <?php if ($img) { ?>
                ...
                <?php if (count($services_slider)>3) : ?>
