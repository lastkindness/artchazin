    ...
    <section <?php if(get_sub_field('animation')): echo 'data-aos="fade-up"'; endif;?> <?php if($id = get_sub_field('id')): echo 'id="' . $id . '"'; endif;?> class="top-slider">
        <div class="container">
            <div class="top-slider__wrapper <?php if (count($top_slider)>3) : echo ' swiper'; endif ; ?>">
                ...
                <?php endif ; ?>
                <?php $white_cards = get_sub_field('white_cards'); ?>
                <div class="top-slider__cardwrap <?php if (count($top_slider)>3) : echo ' swiper-wrapper'; endif ; ?>">
                    <?php while (have_rows('top_slider')) : the_row() ?>
                        <?php if($slide = get_sub_field('slide')) : ?>
                            ...
                            ?>
                            <div class="top-slider__card card <?php if ($white_cards) : echo ' card_white'; endif ; ?> <?php if (count($top_slider)>3) : echo ' swiper-slide'; endif ; ?>">
                                <?php if ($img) { ?>
