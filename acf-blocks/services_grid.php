<?php if($services_grid = get_sub_field('services_grid')): ?>
    ...
    <section <?php if(get_sub_field('animation')): echo 'data-aos="fade-up"'; endif;?> <?php if($id = get_sub_field('id')): echo 'id="' . $id . '"'; endif;?> class="articles">
        <div class="container">
            <div class="articles__wrapper <?php if (count($services_grid)>3) : echo ' swiper'; endif ; ?>">
                <?php if($services_grid_title = get_sub_field('services_grid_title')): ?>
                    <h1 class="articles__title"><?php echo $services_grid_title;?></h1>
                <?php endif ; ?>
                <?php if($services_grid_description = get_sub_field('services_grid_description')): ?>
                    <div class="articles__descr">
                        <p class="p3"><?php echo $services_grid_description;?></p>
                    </div>
                <?php endif ; ?>
                <?php $white_cards = get_sub_field('services_grid_white_cards'); ?>
                <div class="articles__grid">
                    <?php while (have_rows('services_grid')) : the_row() ?>
