<?php
/*
 * Template name: Front Ketubah Template
 */
...
<section class="breadcrumbs">
    <div class="container">
        <div class="breadcrumbs__wrapper">
            ...
            <div class="breadcrumbs__item active"><a href="#" class="breadcrumbs__link">Ketubah Gallery</a></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="ketubah__wrapper">
            <div class="ketubah__descr">
                <h1 class="ketubah__descr-title">Custom Made Ketubah</h1>
                <h2 class="ketubah__descr-subtitle">Mazal Tov!</h2>
                <div class="ketubah__descr-divider divider"></div>
                <p class="ketubah__descr-text">You are now at the peak of your wedding preparations, and have reached the phase of selecting a Ketubah!
    ...
    <div class="container">
        <div class="gallery__wrapper">
            <div class="gallery__grid">
                <div class="gallery__card card card_white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/productcard1.png" alt="" class="gallery__card-img card__img">
                    <div class="card__content gallery__card-content">
                        <h2 class="gallery__card-title card__title">NAME OF PRODUCT</h2>
                        <p class="card__text p3 gallery__card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </p>
                        <div class="gallery__card-price card__price p1">999$</div>
                    </div>
                    <a href="#" class="btn card__btn gallery__card-btn">Go To Order</a>
                </div>
                <div class="gallery__card card card_white">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/src/img/productcard1.png" alt="" class="gallery__card-img card__img">
                    <div class="card__content gallery__card-content">
